...
standard_parameters = {
    ...
    'eyetracking_amplitude':                    25,         # custom calibration x-width
    'sp_path_amplitude':                          20,         # width in degrees of sp amplitude
    ...
    # temporal parameters (NOTE: rerun create_ITIs when changing any of these parameters)
    'target_delay':                                      .300,         # in s this is the saccade delay duration
